...
| TM-005 | Incomplete HIPAA/GDPR accountability and lifecycle controls | Confidential/personal/ePHI stored | Undetected access, over-retention, failed rights/incident response | Entity audit fields, operational logs, backups | Central security audit trail, retention schedule/jobs, export/delete workflow, breach register/runbook, access review | **P0 High** |
...
- Define and automate retention/deletion for chats, analytics, forms, logs, deleted content, recordings, and backups. Provide data export and erasure review workflows.
- Create an incident-response and breach-assessment runbook with evidence preservation, containment, notification decisions, and a GDPR 72-hour escalation clock where applicable.
