    ...
    IServiceProvider? serviceProvider = null) : IAutomationNodeRegistry
{
    ...
    [
        ...
        new("support.ticketCreatedTrigger", 1, "Support Ticket Created", "Starts an active workflow whenever a support ticket is opened, by a contact or by staff on their behalf.", "Triggers", "bi-life-preserver", true, ["main"], "{}"),
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return node.TypeKey switch
        {
            ...
            "support.ticketCreatedTrigger" => SingleOutput("main", input),
